...
int			free_exe(t_exe_data *exe, int ret_val, int free_envp,
			char *err_msg);
...
t_env_data		**env_set(t_env_data **env, char *key,
			char *value);
...
int				add_redirection(t_list **redir_list, char *file, int append,
					int here_doc);
